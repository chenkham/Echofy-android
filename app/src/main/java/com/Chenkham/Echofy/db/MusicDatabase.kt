...
import com.Chenkham.Echofy.db.entities.SortedSongAlbumMap
import com.Chenkham.Echofy.db.entities.SortedSongArtistMap
...
@DeleteColumn(tableName = "album", columnName = "explicit")
@DeleteColumn(tableName = "format", columnName = "perceptualLoudnessDb")
