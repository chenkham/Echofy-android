...
// Redise├▒o 2026 ÔÇö Material 3 Expressive
//
// Filosof├¡a: un ├║nico color de acento alimenta los 5 estilos (en vez de presets
// desconectados por layout). Menos superficie, m├ís variedad real: cada estilo
// se ve genuinamente distinto porque cambia composici├│n y forma, no solo color.
//
// Para agregar un estilo nuevo: 1) entry aqu├¡ en LyricsCardStyle, 2) composable
...
enum class LyricsCardStyle(
    ...
    Tonal(
        displayName = "Tonal",
        description = "Superficie M3 tonal, c├ílida y s├│lida",
    ),
    Glass(
        displayName = "Glass",
        description = "Vidrio l├¡quido esmerilado",
    ),
    CoverBloom(
        displayName = "Cover Bloom",
        description = "La car├ítula protagoniza",
    ),
    Quote(
        displayName = "Quote",
        description = "Tipograf├¡a pura, minimal",
    ),
    Aurora(
        displayName = "Aurora",
 ...
 * as├¡ todos los estilos escalan de forma consistente sin recalcular texto a mano.
 */
...
/**
 * Escala de forma expresiva M3: controla cu├ín "atrevidas" son las esquinas
 * en toda la tarjeta (contenedor, car├ítula, chips).
 */
...
/** Tama├▒o final de la tarjeta (lado corto fijo, lado largo derivado del ratio). */
...
/**
 * Forma "expresiva" asim├®trica: dos esquinas grandes, dos m├ís contenidas.
 * Da personalidad sin necesitar geometr├¡a de blob compleja.
 */
...
data class LyricsCardConfig(
    ...
    /**
     * Multiplicador sobre el tama├▒o de fuente calculado autom├íticamente.
     * Rango recomendado: 0.6f ÔÇô 1.5f
     */
     ...
     * Rango recomendado: 12.dp ÔÇô 36.dp
     */
